        ...
        <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <table class="table table-bordered" id="variantsTable">
                ...
                <tbody>
                    <tr class="variant">
                        <td>
                            <input style="width: 80px;" type="color" class="form-control" name="variants[0][color]" required>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="variants[0][image]" onchange="previewImage(this, 0);" required>
                                <label class="custom-file-label" for="image">Choose file</label>
                            </div>
                            <img id="variantImagePreview_0" src="#" alt="Variant Image Preview" style="max-width: 200px; display: none;">
                        </td>
                        <td>
    ...
    function previewImage(input, variantIndex) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                const imagePreview = document.getElementById('variantImagePreview_' + (variantIndex==null ? "":variantIndex));
