            ...
            <div class="header-top">
                <div class="container">
                    <div class="header-left">
                        <a href="tel:#"><i class="icon-phone"></i>Call: +917199868</a>
                    </div><!-- End .header-left -->
                    ...
                    <div class="header-center">
                        <nav class="main-nav">
                            <ul class="menu sf-arrows">
                                ...
                                <li>
                                    <a href="{{ route('category.index') }}}}" class="sf-with-ul">SHOP</a>
                                ...
                                <li>
                                    <a href="{{ route('category.index') }}}}" class="sf-with-ul">POPULAR</a>
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="{{ asset('assets/images/logo-icon.png') }}" class="logo" alt="logo" width="60" height="15">
                    ...
                    <div class="col-xl-2-5col col-lg-5 ">
                        <img src="{{ asset('assets/images/phones.jpg') }}" class="newsletter-img" alt="newsletter">
                    </div>
                </div>
            </div>
        </div>
